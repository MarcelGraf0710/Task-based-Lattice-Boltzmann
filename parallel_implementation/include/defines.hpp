...
#define VERTICAL_NODES 51 // 15, readable up to 50 in console, beyond not recommended // 14 as for parallel
#define HORIZONTAL_NODES 12 // comfortable console limit: 9 
#define TOTAL_NODE_COUNT VERTICAL_NODES * HORIZONTAL_NODES
#define BOLTZMANN_CONSTANT 1.380649e-23
#define RELAXATION_TIME 1.4
#define TIME_STEPS 100
#define SUBDOMAIN_HEIGHT 12 // 4 as for parallel
