...
int hpx_main()
{
    ...
    parallel_shift_framework_new::setup_parallel_domain(distribution_values, nodes, fluid_nodes, phase_information, access_function);
    ...
    /* Run simulation */
    parallel_shift_framework_new::run
    (
