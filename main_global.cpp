...
{
    std::string algorithm = vm["algorithm-value"].as<std::string>();
    std::string data_layout = vm["data_layout-value"].as<std::string>();
    double relaxation_time = vm["relaxation_time-value"].as<double>();
    std::uint64_t time_steps = vm["time_steps-value"].as<std::uint64_t>();
    std::uint64_t horizontal_nodes = vm["horizontal_nodes-value"].as<std::uint64_t>();
    std::uint64_t vertical_nodes = vm["vertical_nodes-value"].as<std::uint64_t>();
...
int main(int argc, char* argv[])
{
    ...
    /* General definitions */
    desc_commandline.add_options()("algorithm-value",
    ...
    desc_commandline.add_options()("data_layout-value",
