...
for access_pattern in access_patterns:
    ...
    model_tl = numpy.poly1d(numpy.polyfit(core_ticks, parallel_two_lattice_strong_scaling, len(core_ticks)-1))
    model_tlf = numpy.poly1d(numpy.polyfit(core_ticks, parallel_two_lattice_framework_strong_scaling, len(core_ticks)-1))
    model_tf = numpy.poly1d(numpy.polyfit(core_ticks, parallel_two_lattice_framework_strong_scaling, len(core_ticks)-1))
    model_ts = numpy.poly1d(numpy.polyfit(core_ticks, parallel_two_step_strong_scaling, len(core_ticks)-1))
    model_shift = numpy.poly1d(numpy.polyfit(core_ticks, parallel_shift_strong_scaling, len(core_ticks)-1))
    model_swap = numpy.poly1d(numpy.polyfit(core_ticks, parallel_swap_strong_scaling, len(core_ticks)-1))
